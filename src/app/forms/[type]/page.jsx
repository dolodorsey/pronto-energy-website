...
const BRAND = { name: 'Pronto Energy', bg: '#0A0800', accent: '#FF6D00', text: '#FFF3E0', font: "'DM Sans', serif" };
    ...
    <div style={{minHeight:'100vh',background:BRAND.bg,color:BRAND.text,fontFamily:BRAND.font}}>
      ...
      <div style={{position:'relative',zIndex:1,padding:'60px 20px 80px'}}>
        <div style={{maxWidth:560,margin:'0 auto'}}>
          ...
          <p style={{textAlign:'center',marginTop:40,fontSize:11,opacity:0.25,fontFamily:"'DM Sans',sans-serif",letterSpacing:1}}>© {new Date().getFullYear()} Pronto Energy — Powered by The Kollective</p>
        </div>
      </div>
    </div>
  );
