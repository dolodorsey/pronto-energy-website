...
import ProntoConversionLayer from "@/components/ProntoConversionLayer";
import "./globals.css";
import "./experience-layer.css";
import "./conversion-seo.css";

// Keep the Vercel production hostname canonical until the custom DNS cutover is complete.
...
export const metadata: Metadata = {
  ...
  description: "Pronto Energy is a six-flavor energy drink brand built for retail, distribution, fitness, hospitality, events and culture. Explore products, commercial placement and partnerships.",
  ...
  openGraph: {
    title: "Pronto Energy — Six Flavors. Built For Momentum.",
    description: "Explore Pronto products, retail placement, distribution, events and commercial partnerships.",
    type: "website",
    url: `${SITE_URL}/`,
    siteName: "Pronto Energy",
    locale: "en_US",
    images: [{ url:"/images/products/all-flavors-lineup.png", alt:"Pronto Energy flavor lineup" }],
  },
  ...
  return (
    <html lang="en">
      ...
      <body>
        ...
        <ProntoExperienceLayer/>
        {children}
        <ProntoConversionLayer/>
      </body>
    </html>
  );
}
